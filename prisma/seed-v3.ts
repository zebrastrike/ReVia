...
async function main() {
  ...
  const categories = await prisma.category.createManyAndReturn({
    data: [
      ...
      { name: "Metabolic", slug: "metabolic", description: "Peptides targeting metabolic function and body composition." },
  ...
  await createProduct({
    ...
    categorySlug: "metabolic", active: true, featured: true,
  ...
  await createProduct({
    ...
    categorySlug: "metabolic", active: true, tags: ["weight-management"],
    variants: [
  ...
  await createProduct({ name: "REbalance Sample Pack", slug: "rebalance-sample-pack", categorySlug: "capsules", active: false, tags: ["oral", "sample"], variants: [{ label: "10 Capsules", sku: "RV-OCS-REB-10-ORA", retailPrice: 1299, foundersPrice: 999, friendsPrice: 899, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "REcover Sample Pack", slug: "recover-sample-pack", categorySlug: "capsules", active: false, tags: ["oral", "sample"], variants: [{ label: "5 Capsules", sku: "RV-OCS-REC-5-ORA", retailPrice: 1299, foundersPrice: 999, friendsPrice: 899, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "REvive Sample Pack", slug: "revive-sample-pack", categorySlug: "capsules", active: false, tags: ["oral", "sample"], variants: [{ label: "5 Capsules", sku: "RV-OCS-REV-5-ORA", retailPrice: 1299, foundersPrice: 999, friendsPrice: 899, quantity: 0, reorderThreshold: 0 }] });

  // ─── METABOLIC — future ────────────────────────────────────────────────────
  await createProduct({ name: "5-Amino-1MQ", slug: "5-amino-1mq", categorySlug: "metabolic", active: false, tags: ["metabolic", "weight-management"], variants: [{ label: "5mg", sku: "RV-MWM-5AM-5-SC", retailPrice: 5999, foundersPrice: 4799, friendsPrice: 3999, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-MWM-5AM-10-SC", retailPrice: 8999, foundersPrice: 7499, friendsPrice: 6499, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "AOD-9604", slug: "aod-9604", categorySlug: "metabolic", active: false, tags: ["metabolic", "weight-management"], variants: [{ label: "5mg", sku: "RV-MWM-AOD-5-SC", retailPrice: 5999, foundersPrice: 4999, friendsPrice: 4499, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-MWM-AOD-10-SC", retailPrice: 8999, foundersPrice: 7499, friendsPrice: 6999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Adipotide", slug: "adipotide", categorySlug: "metabolic", active: false, tags: ["metabolic", "weight-management"], variants: [{ label: "5mg", sku: "RV-MWM-ADI-5-SC", retailPrice: 9999, foundersPrice: 8499, friendsPrice: 7999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "MOTS-c 40mg", slug: "mots-c-40mg", categorySlug: "metabolic", active: false, tags: ["metabolic", "longevity", "mitochondrial"], variants: [{ label: "40mg", sku: "RV-MWM-MOT-40-SC", retailPrice: 29999, foundersPrice: 19999, friendsPrice: 12999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Mazdutide", slug: "mazdutide", categorySlug: "metabolic", active: false, tags: ["weight-management"], variants: [{ label: "10mg", sku: "RV-MWM-MAZ-10-SC", retailPrice: 18999, foundersPrice: 13999, friendsPrice: 12999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Retatrutide 60mg", slug: "retatrutide-60mg", categorySlug: "metabolic", active: false, tags: ["weight-management"], variants: [{ label: "60mg", sku: "RV-MWM-RET-60-SC", retailPrice: 39999, foundersPrice: 29999, friendsPrice: 22999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Semaglutide", slug: "semaglutide", categorySlug: "metabolic", active: false, tags: ["weight-management"], variants: [{ label: "5mg", sku: "RV-MWM-SEM-5-SC", retailPrice: 9999, foundersPrice: 6499, friendsPrice: 4999, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-MWM-SEM-10-SC", retailPrice: 16999, foundersPrice: 10999, friendsPrice: 8999, quantity: 0, reorderThreshold: 0 }, { label: "30mg", sku: "RV-MWM-SEM-30-SC", retailPrice: 39999, foundersPrice: 27999, friendsPrice: 19999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Tirzepatide 30mg", slug: "tirzepatide-30mg", categorySlug: "metabolic", active: false, tags: ["weight-management"], variants: [{ label: "30mg", sku: "RV-MWM-TIR-30-SC", retailPrice: 22999, foundersPrice: 18899, friendsPrice: 14999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Tirzepatide 60mg", slug: "tirzepatide-60mg", categorySlug: "metabolic", active: false, tags: ["weight-management"], variants: [{ label: "60mg", sku: "RV-MWM-TIR-60-SC", retailPrice: 39999, foundersPrice: 24999, friendsPrice: 19999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "L-Carnitine", slug: "l-carnitine", categorySlug: "metabolic", active: false, tags: ["metabolic", "energy", "liquid"], variants: [{ label: "600mg (liquid)", sku: "RV-SBL-LCA-600-LIQ", retailPrice: 6499, foundersPrice: 4999, friendsPrice: 3999, quantity: 0, reorderThreshold: 0 }] });

  // ─── GROWTH HORMONE — future ───────────────────────────────────────────────
  await createProduct({ name: "AICAR", slug: "aicar", categorySlug: "growth-hormone", active: false, tags: ["performance", "metabolic"], variants: [{ label: "5mg", sku: "RV-GHP-AIC-5-SC", retailPrice: 6299, foundersPrice: 4999, friendsPrice: 4499, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "CJC-1295 with DAC", slug: "cjc-1295-with-dac", categorySlug: "growth-hormone", active: false, tags: ["growth-hormone"], variants: [{ label: "5mg", sku: "RV-GHP-CJCNOD-5-SC", retailPrice: 9999, foundersPrice: 7499, friendsPrice: 6999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Follistatin-344", slug: "follistatin-344", categorySlug: "growth-hormone", active: false, tags: ["growth-hormone", "performance"], variants: [{ label: "1mg", sku: "RV-GHP-FOL-1-SC", retailPrice: 19999, foundersPrice: 14999, friendsPrice: 12999, quantity: 0, reorderThreshold: 0 }] });
  ...
  await createProduct({ name: "HGH Fragment 176-191", slug: "hgh-fragment-176-191", categorySlug: "growth-hormone", active: false, tags: ["growth-hormone", "weight-management"], variants: [{ label: "5mg", sku: "RV-GHP-HGH-5-SC", retailPrice: 9499, foundersPrice: 7999, friendsPrice: 6999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Hexarellin Acetate", slug: "hexarellin-acetate", categorySlug: "growth-hormone", active: false, tags: ["growth-hormone"], variants: [{ label: "5mg", sku: "RV-GHP-HEX-5-SC", retailPrice: 4999, foundersPrice: 4499, friendsPrice: 3999, quantity: 0, reorderThreshold: 0 }] });
  ...
  await createProduct({ name: "Ipamorelin 10mg", slug: "ipamorelin-10mg", categorySlug: "growth-hormone", active: false, tags: ["growth-hormone"], variants: [{ label: "10mg", sku: "RV-GHP-IPA-10-SC", retailPrice: 6999, foundersPrice: 5999, friendsPrice: 4999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Sermorelin 10mg", slug: "sermorelin-10mg", categorySlug: "growth-hormone", active: false, tags: ["growth-hormone"], variants: [{ label: "10mg", sku: "RV-GHP-SER-10-SC", retailPrice: 8499, foundersPrice: 6999, friendsPrice: 5499, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Tesamorelin 10mg", slug: "tesamorelin-10mg", categorySlug: "growth-hormone", active: false, tags: ["growth-hormone", "visceral-fat"], variants: [{ label: "10mg", sku: "RV-GHP-TES-10-SC", retailPrice: 12999, foundersPrice: 10499, friendsPrice: 8499, quantity: 0, reorderThreshold: 0 }] });

  // ─── ANTI-INFLAMMATORY — future ────────────────────────────────────────────
  await createProduct({ name: "KPV", slug: "kpv", categorySlug: "anti-inflammatory", active: false, tags: ["recovery", "anti-inflammatory"], variants: [{ label: "5mg", sku: "RV-HRI-KPV-5-SC", retailPrice: 3499, foundersPrice: 3999, friendsPrice: 2499, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-HRI-KPV-10-SC", retailPrice: 5999, foundersPrice: 4499, friendsPrice: 2999, quantity: 0, reorderThreshold: 0 }] });

  // ─── ANTIMICROBIAL — future ────────────────────────────────────────────────
  await createProduct({ name: "LL-37", slug: "ll-37", categorySlug: "antimicrobial", active: false, tags: ["immune", "antimicrobial"], variants: [{ label: "5mg", sku: "RV-HRI-LL3-5-SC", retailPrice: 7999, foundersPrice: 5999, friendsPrice: 4999, quantity: 0, reorderThreshold: 0 }] });

  // ─── NEUROPROTECTIVE — future ──────────────────────────────────────────────
  await createProduct({ name: "ARA-290", slug: "ara-290", categorySlug: "neuroprotective", active: false, tags: ["recovery", "neuroprotective"], variants: [{ label: "10mg", sku: "RV-HRI-ARA-10-SC", retailPrice: 5999, foundersPrice: 4999, friendsPrice: 3999, quantity: 0, reorderThreshold: 0 }] });

  // ─── RECOVERY — future ─────────────────────────────────────────────────────
  await createProduct({ name: "BPC-157", slug: "bpc-157", categorySlug: "recovery", active: false, tags: ["recovery"], variants: [{ label: "5mg", sku: "RV-HRI-BPC-5-SC", retailPrice: 4999, foundersPrice: 3999, friendsPrice: 2999, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-HRI-BPC-10-SC", retailPrice: 8999, foundersPrice: 5499, friendsPrice: 4499, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "TB-500", slug: "tb-500", categorySlug: "recovery", active: false, tags: ["recovery"], variants: [{ label: "5mg", sku: "RV-HRI-TB5-5-SC", retailPrice: 6999, foundersPrice: 5999, friendsPrice: 4999, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-HRI-TB5-10-SC", retailPrice: 13999, foundersPrice: 10999, friendsPrice: 8999, quantity: 0, reorderThreshold: 0 }] });

  // ─── HORMONE — future ──────────────────────────────────────────────────────
  await createProduct({ name: "Oxytocin Acetate", slug: "oxytocin-acetate", categorySlug: "hormone", active: false, tags: ["hormone", "recovery"], variants: [{ label: "2mg", sku: "RV-HRI-OXY-2-SC", retailPrice: 4999, foundersPrice: 3499, friendsPrice: 2499, quantity: 0, reorderThreshold: 0 }] });

  // ─── IMMUNE — future ───────────────────────────────────────────────────────
  await createProduct({ name: "Thymalin", slug: "thymalin", categorySlug: "immune", active: false, tags: ["immune", "longevity"], variants: [{ label: "10mg", sku: "RV-HRI-THY-10-SC", retailPrice: 5599, foundersPrice: 4499, friendsPrice: 3999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Thymosin Alpha-1", slug: "thymosin-alpha-1", categorySlug: "immune", active: false, tags: ["immune"], variants: [{ label: "5mg", sku: "RV-HRI-TA1-5-SC", retailPrice: 7499, foundersPrice: 6499, friendsPrice: 5999, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-HRI-TA1-10-SC", retailPrice: 12999, foundersPrice: 10499, friendsPrice: 8999, quantity: 0, reorderThreshold: 0 }] });

  // ─── NEUROPEPTIDE — future ─────────────────────────────────────────────────
  await createProduct({ name: "VIP", slug: "vip", categorySlug: "neuropeptide", active: false, tags: ["neuropeptide", "immune"], variants: [{ label: "5mg", sku: "RV-HRI-VIP-5-SC", retailPrice: 6999, foundersPrice: 5499, friendsPrice: 4499, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-HRI-VIP-10-SC", retailPrice: 12999, foundersPrice: 9999, friendsPrice: 7999, quantity: 0, reorderThreshold: 0 }] });

  // ─── LONGEVITY — future ────────────────────────────────────────────────────
  await createProduct({ name: "Epitalon 50mg", slug: "epitalon-50mg", categorySlug: "longevity", active: false, tags: ["longevity", "anti-aging"], variants: [{ label: "50mg", sku: "RV-CL-EPI-50-SC", retailPrice: 19999, foundersPrice: 13999, friendsPrice: 9999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "FOX-04", slug: "fox-04", categorySlug: "longevity", active: false, tags: ["longevity", "senolytic"], variants: [{ label: "10mg", sku: "RV-CL-FOX-10-SC", retailPrice: 29999, foundersPrice: 23999, friendsPrice: 19999, quantity: 0, reorderThreshold: 0 }] });

  // ─── MITOCHONDRIAL — future ────────────────────────────────────────────────
  await createProduct({ name: "Humanin 10mg", slug: "humanin-10mg", categorySlug: "mitochondrial", active: false, tags: ["longevity", "neuroprotective"], variants: [{ label: "10mg", sku: "RV-CL-HUM-10-SC", retailPrice: 11999, foundersPrice: 8499, friendsPrice: 7999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "NAD+", slug: "nad-plus", categorySlug: "mitochondrial", active: false, tags: ["longevity", "mitochondrial", "energy"], variants: [{ label: "100mg", sku: "RV-CL-NAD-100-SC", retailPrice: 4499, foundersPrice: 2999, friendsPrice: 2499, quantity: 0, reorderThreshold: 0 }, { label: "500mg", sku: "RV-CL-NAD-500-SC", retailPrice: 21999, foundersPrice: 14999, friendsPrice: 5999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "SLU-PP-332 (future)", slug: "slu-pp-332-future", categorySlug: "mitochondrial", active: false, tags: ["metabolic", "mitochondrial"], variants: [{ label: "5mg", sku: "RV-CL-SLU-5-SC-F", retailPrice: 9999, foundersPrice: 8499, friendsPrice: 6999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "SS-31 (Elamipretide)", slug: "ss-31-elamipretide", categorySlug: "mitochondrial", active: false, tags: ["longevity", "mitochondrial"], variants: [{ label: "10mg", sku: "RV-CL-SS3-10-SC-F", retailPrice: 6999, foundersPrice: 5999, friendsPrice: 4999, quantity: 0, reorderThreshold: 0 }] });

  // ─── NOOTROPIC — future ────────────────────────────────────────────────────
  await createProduct({ name: "Cerebrolysin", slug: "cerebrolysin", categorySlug: "nootropic", active: false, tags: ["nootropic", "neuroprotective"], variants: [{ label: "60mg (liquid)", sku: "RV-CL-CER-60-LIQ", retailPrice: 3999, foundersPrice: 3499, friendsPrice: 2499, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Dihexa", slug: "dihexa", categorySlug: "nootropic", active: false, tags: ["nootropic"], variants: [{ label: "5mg", sku: "RV-CL-DIH-5-SC", retailPrice: 7999, foundersPrice: 5999, friendsPrice: 4999, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-CL-DIH-10-SC", retailPrice: 12999, foundersPrice: 8999, friendsPrice: 6999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Pinealon", slug: "pinealon", categorySlug: "nootropic", active: false, tags: ["nootropic", "longevity"], variants: [{ label: "10mg", sku: "RV-CL-PIN-10-SC", retailPrice: 5999, foundersPrice: 4999, friendsPrice: 3999, quantity: 0, reorderThreshold: 0 }, { label: "20mg", sku: "RV-CL-PIN-20-SC", retailPrice: 9999, foundersPrice: 6999, friendsPrice: 5999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Selank", slug: "selank", categorySlug: "nootropic", active: false, tags: ["nootropic", "anxiolytic"], variants: [{ label: "5mg", sku: "RV-CL-SEL-5-SC", retailPrice: 2999, foundersPrice: 2499, friendsPrice: 1999, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-CL-SEL-10-SC", retailPrice: 4499, foundersPrice: 3499, friendsPrice: 2999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Semax", slug: "semax", categorySlug: "nootropic", active: false, tags: ["nootropic"], variants: [{ label: "5mg", sku: "RV-CL-SEM-5-SC", retailPrice: 2999, foundersPrice: 2499, friendsPrice: 1999, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-CL-SEM-10-SC", retailPrice: 4499, foundersPrice: 3499, friendsPrice: 2999, quantity: 0, reorderThreshold: 0 }] });

  // ─── REPRODUCTIVE — future ─────────────────────────────────────────────────
  await createProduct({ name: "Kisspeptin", slug: "kisspeptin", categorySlug: "reproductive", active: false, tags: ["hormone", "reproductive"], variants: [{ label: "5mg", sku: "RV-SHS-KIS-5-SC", retailPrice: 5999, foundersPrice: 4999, friendsPrice: 3999, quantity: 0, reorderThreshold: 0 }, { label: "10mg", sku: "RV-SHS-KIS-10-SC", retailPrice: 9999, foundersPrice: 6999, friendsPrice: 4499, quantity: 0, reorderThreshold: 0 }] });

  // ─── SEXUAL HEALTH — future ────────────────────────────────────────────────
  await createProduct({ name: "PT-141", slug: "pt-141", categorySlug: "sexual-health", active: false, tags: ["sexual-health"], variants: [{ label: "10mg", sku: "RV-SHS-PT1-10-SC", retailPrice: 5499, foundersPrice: 4499, friendsPrice: 3999, quantity: 0, reorderThreshold: 0 }] });

  // ─── SLEEP — future ────────────────────────────────────────────────────────
  await createProduct({ name: "DSIP", slug: "dsip", categorySlug: "sleep", active: false, tags: ["sleep"], variants: [{ label: "5mg", sku: "RV-SHS-DSI-5-SC", retailPrice: 4999, foundersPrice: 4499, friendsPrice: 2999, quantity: 0, reorderThreshold: 0 }, { label: "15mg", sku: "RV-SHS-DSI-15-SC", retailPrice: 12999, foundersPrice: 8999, friendsPrice: 5999, quantity: 0, reorderThreshold: 0 }] });

  // ─── TANNING — future ──────────────────────────────────────────────────────
  await createProduct({ name: "Melanotan-1", slug: "melanotan-1", categorySlug: "tanning", active: false, tags: ["tanning", "skin"], variants: [{ label: "10mg", sku: "RV-SHS-MT1-10-SC", retailPrice: 4499, foundersPrice: 3799, friendsPrice: 2999, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Melanotan-2", slug: "melanotan-2", categorySlug: "tanning", active: false, tags: ["tanning", "sexual-health"], variants: [{ label: "10mg", sku: "RV-SHS-MT2-10-SC", retailPrice: 3499, foundersPrice: 2999, friendsPrice: 2499, quantity: 0, reorderThreshold: 0 }] });

  // ─── COSMETIC — future ─────────────────────────────────────────────────────
  await createProduct({ name: "SNAP-8", slug: "snap-8", categorySlug: "cosmetic", active: false, tags: ["aesthetics", "topical", "skin"], variants: [{ label: "10mg", sku: "RV-TS-SNA-10-SC", retailPrice: 3499, foundersPrice: 2999, friendsPrice: 2299, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "SNAP-8 + GHK-Cu Serum", slug: "snap-8-ghk-cu-serum", categorySlug: "cosmetic", active: false, tags: ["aesthetics", "topical", "serum"], variants: [{ label: "30ml", sku: "RV-TS-SNA-30-SER", retailPrice: 5999, foundersPrice: 4499, friendsPrice: 3499, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "PRiVIVE Transdermal", slug: "privive-transdermal", categorySlug: "cosmetic", active: false, tags: ["aesthetics", "topical", "serum"], variants: [{ label: "30ml", sku: "RV-TS-PRI-30-SER", retailPrice: 9999, foundersPrice: 6999, friendsPrice: 5999, quantity: 0, reorderThreshold: 0 }] });

  // ─── ANTIOXIDANT — future ──────────────────────────────────────────────────
  await createProduct({ name: "Glutathione", slug: "glutathione", categorySlug: "antioxidant", active: false, tags: ["antioxidant", "immune"], variants: [{ label: "1,500mg", sku: "RV-SBL-GLU-1500-SC", retailPrice: 5999, foundersPrice: 4499, friendsPrice: 3999, quantity: 0, reorderThreshold: 0 }] });

  // ─── STACKS — future blends/liquids ────────────────────────────────────────
  await createProduct({ name: "LC120", slug: "lc120", categorySlug: "stacks", active: false, tags: ["metabolic", "energy", "liquid"], variants: [{ label: "10ml", sku: "RV-SBL-LC1-10-LIQ", retailPrice: 5499, foundersPrice: 4499, friendsPrice: 3499, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "LC216", slug: "lc216", categorySlug: "stacks", active: false, tags: ["metabolic", "energy", "liquid"], variants: [{ label: "10ml", sku: "RV-SBL-LC2-10-LIQ", retailPrice: 5999, foundersPrice: 4499, friendsPrice: 3499, quantity: 0, reorderThreshold: 0 }] });
  await createProduct({ name: "Super Human Blend", slug: "super-human-blend", categorySlug: "stacks", active: false, tags: ["blend", "liquid", "performance"], variants: [{ label: "10ml", sku: "RV-SBL-SUP-10-LIQ", retailPrice: 7999, foundersPrice: 6499, friendsPrice: 4499, quantity: 0, reorderThreshold: 0 }] });
