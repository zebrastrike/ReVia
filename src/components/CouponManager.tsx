    ...
    <div className="space-y-6">
      ...
      {!showForm ? (
        <button
          ...
          className="flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-500"
        >
          <Plus size={16} />
          New Coupon
        </button>
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                disabled={creating}
                className="flex items-center gap-2 rounded-xl bg-emerald-600 px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-500 disabled:opacity-60"
              >
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        className="text-white/20 transition hover:text-red-400 disabled:opacity-50"
                      >
